    ...
    <footer class="footer has-cards">
        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-primary font-weight-light mb-2">Thank you for visiting our website!</h3>
                    <h4 class="mb-0 font-weight-light">Let's get in touch on any of these platforms.</h4>
                </div>
                <div class="col-lg-6 text-lg-center btn-wrapper">
                    <a target="_blank" href="https://twitter.com/smitpatelx"
                       class="btn btn-neutral btn-icon-only btn-twitter btn-round btn-lg" data-toggle="tooltip"
                       data-original-title="Follow us">
                        <i class="fab fa-twitter-square"></i>
                    </a>
                    <a target="_blank" href="https://discord.gg/nFTec5q"
                       class="btn btn-neutral btn-icon-only btn-facebook btn-round btn-lg" data-toggle="tooltip"
                       data-original-title="Like us">
                        <i class="fab fa-discord"></i>
                    </a>
                    <a target="_blank" href="https://dribbble.com/smitpatelx"
                       class="btn btn-neutral btn-icon-only btn-dribbble btn-lg btn-round" data-toggle="tooltip"
                       data-original-title="Follow us">
                        <i class="fab fa-dribbble"></i>
                    </a>
                    <a target="_blank" href="https://github.com/smitpatelx"
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; 2018
                        <a href="https://netdevv.com" target="_blank">Netdevv</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <ul class="nav nav-footer justify-content-end">
                        ...
                        <li class="nav-item">
                            <a href="https://github.com/smitpatelx"
                               class="nav-link" target="_blank">Git Hub</a>
                        </li>
                    </ul>
                </div>
            </div>
